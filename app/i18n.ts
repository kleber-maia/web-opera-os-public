...
const en = {
  ...
  hero: {
    ...
    stageAria: "Operator working across OperateOS and the open web", status: "Yours", identity: "The operating system your business owns.", factsLabel: "OperateOS ownership details",
    facts: [["Operator", "Built in"], ["Hardware", "Yours"]], scroll: "Enter the system",
  },
  systemParts: [
    ...
    ["Its own AI agent.", "Operator browses, handles routine work, and helps get things done.", "part-agent"],
    ["Extendable.", "Add modules, workflows, and capabilities as the business grows.", "part-extendable"],
    ["Hosted on your own hardware.", "The business keeps control of its system and data.", "part-hardware"],
  ],
  system: {
...
const ptBR: Copy = {
  ...
  hero: {
    ...
    stageAria: "Operator trabalhando no OperateOS e na internet aberta", status: "Seu", identity: "O sistema operacional que o seu negócio possui.", factsLabel: "Detalhes de propriedade do OperateOS",
    facts: [["Operator", "Integrado"], ["Hardware", "Seu"]], scroll: "Conheça o sistema",
  },
  systemParts: [
    ...
    ["Seu próprio agente de IA.", "O Operator navega, cuida do trabalho rotineiro e ajuda a fazer as coisas acontecerem.", "part-agent"],
    ["Extensível.", "Adicione módulos, fluxos de trabalho e capacidades à medida que o negócio cresce.", "part-extendable"],
    ["Hospedado no seu próprio hardware.", "O negócio mantém o controle do seu sistema e dos seus dados.", "part-hardware"],
  ],
  system: {
...
const es419: Copy = {
  ...
  hero: {
    ...
    stageAria: "Operator trabajando en OperateOS y en internet abierto", status: "Tuyo", identity: "El sistema operativo que tu negocio posee.", factsLabel: "Detalles de propiedad de OperateOS",
    facts: [["Operator", "Integrado"], ["Hardware", "Tuyo"]], scroll: "Conoce el sistema",
  },
  systemParts: [
    ...
    ["Su propio agente de IA.", "Operator navega, se encarga del trabajo rutinario y ayuda a hacer las cosas.", "part-agent"],
    ["Extensible.", "Añade módulos, flujos de trabajo y capacidades a medida que crece tu negocio.", "part-extendable"],
    ["Alojado en tu propio hardware.", "El negocio mantiene el control de su sistema y sus datos.", "part-hardware"],
  ],
  system: {
