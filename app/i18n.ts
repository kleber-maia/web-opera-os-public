...
const en = {
  ...
  systemParts: [
    ...
    ["Customizable.", "Shape OperateOS around the way the business works.", "part-customizable"],
...
const ptBR: Copy = {
  ...
  systemParts: [
    ...
    ["Personalizável.", "Adapte o OperateOS à forma como o negócio trabalha.", "part-customizable"],
