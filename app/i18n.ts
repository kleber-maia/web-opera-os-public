...
const en = {
  ...
  ownership: {
    ...
    proofs: [["Self-hosted", "Runs on business-controlled infrastructure."], ["Private by design", "Business records stay inside OperateOS."], ["Model freedom", "Choose the AI provider and model that fits."], ["Built to endure", "Backups, encrypted credentials, and signed updates."]],
...
const ptBR: Copy = {
  ...
  ownership: {
    ...
    proofs: [["Hospedagem própria", "Executado em infraestrutura controlada pelo negócio."], ["Privado por design", "Os registros permanecem dentro do OperateOS."], ["Liberdade de modelo", "Escolha o provedor e o modelo de IA mais adequados."], ["Feito para durar", "Backups, credenciais criptografadas e atualizações assinadas."]],
