...
const en = {
  ...
  systemParts: [
    ["OperateOS", "Operating system for your business", "part-system"],
    ["Operator", "Its own AI agent", "part-agent"],
    ["Customizable", "Shape it around the way your business works", "part-customizable"],
    ["Extendable", "Add modules, workflows, and capabilities as the business grows", "part-extendable"],
    ["Your hardware", "Hosted on hardware your business owns", "part-hardware"],
    ["AI Chat + channels", "Reach Operator wherever work starts", "part-web"],
  ],
  system: {
...
const ptBR: Copy = {
  ...
  systemParts: [
    ["OperateOS", "Sistema operacional para o seu negócio", "part-system"],
    ["Operator", "Seu próprio agente de IA", "part-agent"],
    ["Personalizável", "Adapte o OperateOS ao jeito como o negócio trabalha", "part-customizable"],
    ["Extensível", "Adicione módulos, fluxos de trabalho e capacidades à medida que o negócio cresce", "part-extendable"],
    ["Seu hardware", "Hospedado no hardware próprio do negócio", "part-hardware"],
    ["AI Chat + canais", "Encontre o Operator onde o trabalho começa", "part-web"],
  ],
  system: {
...
const es419: Copy = {
  ...
  systemParts: [
    ["OperateOS", "Sistema operativo para tu negocio", "part-system"],
    ["Operator", "Su propio agente de IA", "part-agent"],
    ["Personalizable", "Adapta OperateOS a la forma en que trabaja tu negocio", "part-customizable"],
    ["Extensible", "Añade módulos, flujos de trabajo y capacidades a medida que crece tu negocio", "part-extendable"],
    ["Tu hardware", "Alojado en el hardware de tu negocio", "part-hardware"],
    ["AI Chat + canales", "Llega a Operator donde empieza el trabajo", "part-web"],
  ],
  system: {
